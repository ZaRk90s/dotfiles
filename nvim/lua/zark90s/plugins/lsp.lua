return {
    ...
    config = function()
        ...
        require("mason-lspconfig").setup({
            ensure_installed = {
                "asm_lsp", -- download cargo
                "astro", -- download nodejs
                "bashls",
                "cmake",
                "clangd", -- if you are using ARM 64 execute the following commands
                -- sudo apt install clangd jq
            ...
            handlers = {
                ...
                ["clangd"] = function()
                    require("lspconfig").clangd.setup {
                        capabilities = capabilities,
                        cmd = { "/usr/bin/clangd", "--background-index" }, -- Use system clangd
                    }
                end,
