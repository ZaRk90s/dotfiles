...
```bash
git clone https://github.com/ZaRk90s/NixOS.git
```

2. Edit `configuration.nix` and change the `user` variable to your username.

3. Run `nixos-install` and follow the instructions.
