...
if [ -f /usr/share/zsh-sudo/zsh-sudo.plugin.zsh ]; then
  source /usr/share/zsh-sudo/zsh-sudo.plugin.zsh
fi
...
export PATH=/home/user/.local/kitty.app/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/sbin/
